    ...
    var i18n_instance={
        zh:{
            ...
            settings:{
                ...
                save:"保存内容",
                copy:"复制",
                fastTitle:"<h5>通过 <kbd>ctrl + c</kbd> 复制以下地址,打开浏览器快速参数设置</h5>"
            },
            auth:{
                cancel:"注销",
                save:"保存",
        ...
        en:{
            ...
            message:{
                ...
                settings:{
                    plusFail:"enhancements cannot be turned on. Make sure that the annotation is enabled on the back end",
                    plusError:"Unable to turn on Enhancement, Error Cause:",
                ...
                offline:{
                    ...
                    note:"provides markdwon-formatted offline documents that developers can copy and convert to HTML or PDF through other markdown conversion tools.."
                },
                debug:{
