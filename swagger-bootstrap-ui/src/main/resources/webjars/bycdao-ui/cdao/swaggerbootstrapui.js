(function ($) {
    ...
    var SwaggerBootstrapUi=function (options) {
        ...
        //文档id
        this.docId="content";
        this.title="swagger-specialRooter-ui";
        this.titleOfUrl="";
        this.load=1;
        //tabid
        this.tabId="tabUl";
        ...
        this.version="2.9.2";
        this.requestOrigion="SwaggerSpecialRooterUi";
    ...
    SwaggerBootstrapUi.prototype.createDetailMenu=function () {
        ...
        var modelsLi=$('<li  class="detailMenu"><a href="javascript:void(0)"><i class="icon-text-width iconfont icon-modeling"></i><span class="menu-text">接口模型 </span></a></li>');
    ...
    SwaggerBootstrapUi.prototype.createSettingsPage=function () {
        ...
        var layui=that.layui;
        var element=layui.element;
        var tabId="SwaggerSpecialRooterUiSettingsScript";
        var i18n=that.i18n.instance;
    ...
    * 获取全局缓存auth信息
    ...
    SwaggerBootstrapUi.prototype.createSecurityElement=function () {
        ...
        var layui=that.layui;
        var element=layui.element;
        var tabId="SwaggerSpecialRooterUiSecurityScript"+md5(that.currentInstance.name);
        var tabContetId="layerTab"+tabId;
        var i18n=that.i18n.instance;
        setTimeout(function () {
            if(!that.tabExists(tabId)){
                that.currentInstance.securityArrs=that.getSecurityInfos();
                var html = template('SwaggerSpecialRooterUiSecurityScript', that.currentInstance);
                var tabObj={
                    id:tabId,
    ...
    SwaggerBootstrapUi.prototype.createDescriptionElement=function () {
        ...
        //that.getDoc().html("");
        setTimeout(function () {
            var html = template('SwaggerSpecialRooterUiIntroScript', that.currentInstance);
    ...
    SwaggerBootstrapUi.prototype.createModelsElement=function () {
        ...
        var tabId="SwaggerSpecialRooterUiModelsScript"+that.currentInstance.id;
        setTimeout(function () {
            if(!that.tabExists(tabId)){
                var html = template("SwaggerSpecialRooterUiModelsScript", that.currentInstance);
                var title="接口模型 ("+that.currentInstance.name+")";
                var tabObj={
                    id:tabId,
                    title:title,
                    content:html
                            ...
                            treetable.render({
                                ...
                                cols: [[
                                    ...
                                    },
                                    {
                                        ...
                                        width: '30%',
                                        templet:"#SwaggerSpecialRooterUiModelsDescriptionTpl"
                                    },
                                    {
                                        field: 'schemaValue',
                                        title: 'schema',
